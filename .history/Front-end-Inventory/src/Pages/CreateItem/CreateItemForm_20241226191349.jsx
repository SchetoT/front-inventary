...
const CreateItemForm = () => {
  ...
  // Aquí puedes obtener el userName de alguna manera, por ejemplo, del estado global o sesión
  const userName = 'user_id_aqui'; // Reemplázalo por el userName real de tu sistema
  ...
  const handleSubmit = async (e) => {
    ...
    data.append('userName', userName);  // Aquí agregamos el userName
