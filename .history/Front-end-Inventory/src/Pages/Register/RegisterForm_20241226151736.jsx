...
const RegisterForm = () => {
  const [formData, setFormData] = useState({
    ...
    email: '',
    password: '',
    role: 'admin', // Puedes cambiar esto para permitir que el usuario seleccione el rol
  });

  // Estados para manejar el error, el éxito y la carga
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Si todo es correcto, se muestra el mensaje de éxito
      setSuccess(true);
